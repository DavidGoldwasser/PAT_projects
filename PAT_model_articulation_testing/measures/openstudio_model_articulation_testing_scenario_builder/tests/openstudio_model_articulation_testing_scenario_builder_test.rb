...
class OpenStudioModelArticulationTestingScenarioBuilder_Test < MiniTest::Unit::TestCase
...
=begin
    # save osw
    new_osw = runner.workflow
    output_osw_path = OpenStudio::Path.new(File.dirname(__FILE__) + "/output/#{test_name}_test_output.osw")
    new_osw.saveAs(output_osw_path)
=end

  end

  def test_good_arg_values
    args = {}
