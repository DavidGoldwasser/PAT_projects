...
module OsLib_ReportingHeatGainLoss
  ...
  def self.heat_gains_section(model, sqlFile, runner, name_only = false)
    ...
    tables << @ventilation_gain_table = OsLib_ReportingHeatGainLoss.monthly_table_with_totals(model, sqlFile, runner,'Zone Mechanical Ventilation Cooling Load Increase Energy','J','kBtu')
  ...
  def self.heat_losses_section(model, sqlFile, runner, name_only = false)
    ...
    tables << @ventilation_loss_table = OsLib_ReportingHeatGainLoss.monthly_table_with_totals(model, sqlFile, runner,'Zone Mechanical Ventilation Heating Load Increase Energy','J','kBtu')
