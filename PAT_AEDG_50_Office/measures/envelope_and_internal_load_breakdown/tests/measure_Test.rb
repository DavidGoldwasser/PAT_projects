...
class EnvelopeAndInternalLoadBreakdown_Test < MiniTest::Unit::TestCase
  ...
  def test_good_argument_values
    ...
    measure = EnvelopeAndInternalLoadBreakdown.new
    ...
    args_hash = {}
    #args_hash["ventilation_reporting"] = "Zone Ventilation"
  ...
  def no_test_no_ext_surfaces
    test_name = 'no_ext_surfaces'
