...
#start the measure
class NetZeroK12Kitchen < OpenStudio::Ruleset::ModelUserScript

  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return " Net Zero K12 Kitchen"
  end
  ...
  def run(model, runner, user_arguments)
	...
	ruleset_name = "AEDG K-12 Kitchen Flow Fraction Schedule"
      winter_design_day = [[24,1]]
      summer_design_day = [[24,1]]
    ...
    # Refrigeration Equipment (Anoop commenented lines 398 to 657. Deleting refrigeration components since it has been included in kitchen loads)
...
NetZeroK12Kitchen.new.registerWithApplication