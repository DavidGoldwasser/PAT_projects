...
#start the measure
class NetZeroK12InteriorLighting < OpenStudio::Ruleset::ModelUserScript
  
  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "Net Zero K12 Interior Lighting"
  end
...
NetZeroK12InteriorLighting.new.registerWithApplication