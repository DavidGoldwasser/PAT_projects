...
#start the measure
class NetZeroK12HVAC < OpenStudio::Ruleset::ModelUserScript

  #define the name that a user will see, this method may be deprecated as
  #the display name in PAT comes from the name field in measure.xml
  def name
    return "Net Zero K12 HVAC"
  end
...
=end
    ...
    aedgTipsLong = ""
    OsLib_HVAC_zedg_gshp.reportConditions(model, runner, "final",aedgTipsLong)
...
NetZeroK12HVAC.new.registerWithApplication