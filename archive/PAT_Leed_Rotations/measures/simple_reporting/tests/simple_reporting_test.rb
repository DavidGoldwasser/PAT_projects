...
class SimpleReporting_Test < MiniTest::Unit::TestCase
  ...
  def test_good_argument_values
    ...
    if not File.exist?(sql_path(test_name))
      setup_test(test_name, idf_output_requests)
    else
      #enable line below if you want to always to re-run simulation
      #setup_test(test_name, idf_output_requests)
    end
