...
# start the measure
class ZEDGK12InsertGroundDomainBasementEKusdua < OpenStudio::Ruleset::WorkspaceUserScript
...
ZEDGK12InsertGroundDomainBasementEKusdua.new.registerWithApplication
